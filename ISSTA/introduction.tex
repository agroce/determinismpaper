...
behavior, without having to observe a test actually fail due to nondeterminism.  we additionally introduce the first variation of delta-debugging that properly handles probabilistic faults and reduction properties.
...
tests, and, most importantly, detection of 
