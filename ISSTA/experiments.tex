...
We removed 11 calls from the {\tt redis} harness, and  modified 2
calls, after
...
detected by TSTL can be demonstrated with standalone tests that do not depend on any TSTL code.
