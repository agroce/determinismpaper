...
horizontal determinism.  However, in some instances, as we discuss
below, vertical determinism can be extremely important, both for
correctness and for ease-of-use of software interfaces.
