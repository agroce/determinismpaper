...
that could produce a flaky test, but it does not have to do so.
...
captures our more lightweight approach to checking for failure
nondeterminism.  Note that unlike all of the other ways to demonstrate
nondeterminism, this second type of failure nondeterminism does not
require the use of $v$, or even the notion of observable components of
a state, or (for that matter) any comparison of states.
