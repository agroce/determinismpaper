...
\xrightarrow[]{\alpha_{n-1}} s_n$ where $s_0 \in I$ and $\forall n
. (s_n, \alpha_n, s_{n+1}) \in T$.
...
captures our more lightweight approach to checking for failure nondeterminism.
