...
determinism check, using the same seed.  Of these, 71 could not even be killed by 120
seconds of testing using complete differential testing with Mac OS X
as a reference, a kill rate of only 27.6\%.  In contrast, the kill rate for the entire set of 1478
mutants not killed when not using a reference, using 120 seconds of
differential testing was...