...
in over 2,000 Python tests, inside and outside Google \cite{pyfakefs}.
...
the existence of a reference POSIX implementation.
...
immediately, even without using a reference, when we compile the harness
