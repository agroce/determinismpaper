...
less than 8\%.  Detecting the fault using a reference file system also
required 17\% more time, and took about twice as long to reduce to a
...
algorithm).  Reducing this test to a minimal test of only 6 steps
requires another 92 seconds, and shows the problem very clearly.
