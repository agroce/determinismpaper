...
observed probability of nondeterminism.  The overhead for adding
nondeterminism checking is 
...
Average branch coverage, for regression tests of length 200 is reduced
by less than 5 branches.  Obviously, it is
...
Moreover, turning off sources of known, expected nondeterminism makes
...
determinism checks, with a 0 second delay between operations, is only
...
checking for process nondeterminism, with a zero delay on operations,
